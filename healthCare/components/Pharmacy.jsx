...
const Pharmacy = ({ pharmacyInfo, onPressChatPage }) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={openModal} style={styles.pharmacyCard}>
        <View style={styles.profileContainer}>
          <Image source={pharmacyInfo.image} style={styles.profileImage} />
        </View>
        <View style={styles.detailsContainer}>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity style={styles.modalButton} onPress={onPressChatPage}>
              <Text style={styles.buttonText}>Chat With Pharmacy</Text>
            </TouchableOpacity>
