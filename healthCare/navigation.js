...
import WaitScreen from './screans/WaitScrean '
...
export default function Navigation(){
    return(
     <NavigationContainer>
      ...
      <Stack.Screen name="Laboratorys" component={LabScreen} />
        <Stack.Screen name="Home" component={HomeScrean} />
        <Stack.Screen name="Login" component={LoginScrean} />
        <Stack.Screen name="Register" component={RegisterAsDoctor}/>
         <Stack.Screen name="doctor sign " component={RegisterScrean} />
